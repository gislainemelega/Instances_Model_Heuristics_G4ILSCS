...
//Upper Bound: Hybrid Heuristic: relax-and-fix procedure (level-oriented decomposition) 
...
// ************************************************** //
		  ...
		  out << "* Upper Bound: Hybrid Heuristic: relax-and-fix procedure (level-oriented decomposition)" << endl;
...
//The Relax-and-Fix procedure with level-oriented decomposition 
//For each level-window, the whole problem is considered and the
//integrality of the binary setup decisions belonging to this 
//level is added; the resulting mixed-integer problem (with 
//fixed, integer, and relaxed decision variables) is solved
//Note: the decomposition is according to the binary setup decisions.
//Level-oriented decomposition: 
//1) L2 - Cutting Stock Problem (cutting patterns) 
//2) L3/L4 - Lot-Sizing Problem/Loading Problem (final products) 
//3) L1/L1A - Lot-Sizing Problem/Supplier Selection Problem (objects) 
...
// *********************************** //
		  ...
		  //Counting of interations in the Hybrid Heuristic 
		  int it_HH = 1; 
		  ...
		  //Relax-and-Fix procedure with level-oriented decomposition
		  ...
		  out << endl << endl;
		  out << "* Level-oriented decomposition: 1) L2 -     Cutting Stock Problem (cutting patterns)" << endl;
		  out << "           parameters           2) L3/L4 -  Lot-Sizing Problem/Loading Problem (final products)" << endl; 
		  out << "                                3) L1/L1A - Lot-Sizing Problem/Supplier Selection Problem (objects)" << endl;
		  out << endl << endl;
		 ...
		 //In the level-oriented decomposition, the number 
		 //of windows is equal to the number of levels with
		 //binary setup decisions (Levels 1/1A, 2, 3/4)
		 //The total available time is split equaly between the windows
		 int nit = 3;
		  ...
		  for(; ;){
				  ...
				  //Consider the integrality of the binary setup variables for
				  //each one of the problems in the level-oriented decomposition
				  //according to the interations of the Relax-and-Fix procedure
				  //Converte the linear variables to binary variables
				  //Interation 1: Level 2
				  if (it_HH == 1) {
					                 //Cutting Patterns
								     for(t=0; t<T; t++)
				  ...
				  //Interation 3: Level 2, 3/4 and 1/1A 
				  //(last iteration)
				  if (it_HH == 3) {
					                 //Cutting Patterns, 
					                 //Final Products 
									 ...
									 //Add the integrality of all the remaining variables 
				  ...
				  //The Hybrid Heuristics STOPS by reaching the last iteration (it_HH == 3)
				  ...
				  //Recover the values of the binary setup variables for each
				  //one of the problems in the level-oriented decomposition
				  //according to the interations of the Relax-and-Fix procedure
				  //Note: there is no fixing in the last iteration (it_HH = 3)
				  //Interation 1: Level 2
				  if (it_HH ==  1) {
									  //Cutting Patterns
									  for(t=0; t<T; t++)
				  ...
				  //for each one of the problems in the 
				  //level-oriented decomposition according to the
				  //interations of the Relax-and-Fix procedure
				  //Note: there is no fixing in the last iteration (it_HH = 3)
				  //Interation 1: Level 2
				  if (it_HH ==  1) {
									  //Cutting Patterns
				  ...
				  //for all the problems in the level-oriented decomposition
				  //according to the interations of the Relax-and-Fix procedure
				  ...
				  //Interation 2: Level 2 and 3
				  if (it_HH == 2) {
									 //Cutting Patterns and Final Products
								     for(t=0; t<T; t++){
										MPmodel.remove(convYJ[t]);
				  ...
				  //Move to the next level-window in the Hybrid Heuristic by
				  //increasing the number of iterations in the Hybrid Heuristic
				  it_HH += 1;
