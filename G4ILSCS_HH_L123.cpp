...
//1) L1/L1A - Lot-Sizing Problem/Supplier Selection Problem (objects) 
//2) L2 - Cutting Stock Problem (cutting patterns) 
//3) L3/L4 - Lot-Sizing Problem/Loading Problem (final products) 
...
// *********************************** //
		  ...
		  out << endl << endl;
		  out << "* Level-oriented decomposition: 1) L1/L1A - Lot-Sizing Problem/Supplier Selection Problem (objects)" << endl;
		  out << "           parameters           2) L2 -     Cutting Stock Problem (cutting patterns)" << endl;
		  out << "                                3) L3/L4 -  Lot-Sizing Problem/Loading Problem (final products)" << endl; 
		  out << endl << endl;
		 ...
		 int nit = 3;
		  ...
		  for(; ;){
				  ...
				  //Interation 3: Level 1/1A, 2 and 3/4 
				  //(last iteration)
				  if (it_HH == 3) {
					                 //Objects, Suppliers,
					                 //Cutting Patterns, 
